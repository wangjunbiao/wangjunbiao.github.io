...
因 `GitHub Pages` 只能托管静态内容，所以以往搭建在 GitHub 上的博客程序多是通过客户端生成 HTML 之后，再同步到 GitHub Pages 上实现的博客功能。YH's_Blog 通过 `GitHub HTTP API` 实现了无需客户端转义的纯 MarkDown 博客程序。
...
##如何使用 「YH's_Blog - GitHub Pages 特别版」
